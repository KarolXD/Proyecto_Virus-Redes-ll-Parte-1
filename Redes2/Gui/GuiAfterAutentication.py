...
C8= tk.Checkbutton(app, text = "Todo C:", variable=tipoescaneo,onvalue=8, offvalue=-8, height=5, width = 10)
C8.pack()
C8.place(x=160, y=260)


C9= tk.Checkbutton(app, text = "Completo Dir", onvalue=9, offvalue= -9, height=5, width = 10)
C9.pack()
